...
def build_alliance_panels(tables) -> dict:
    ...
    return {
        "user_day": user_day,  # DataFrame
        "guild_day": guild_day,  # DataFrame
        "asi_daily": asi_daily,
        "guild_day": guild_day,# DataFrame
        "shapley_payouts": shapley_df,  # DataFrame
        "retention": retention_df,  # DataFrame
        "network": network_df,  # DataFrame (если есть)
        "meta": meta_dict,  # обычный dict со скалярами
    }
